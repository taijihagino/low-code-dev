...
![image](https://github.com/taijihagino/low-code-dev/assets/12064399/a2230cb0-d8e1-4b8e-96b0-620b59958443)<br><br>
...
既存レコードの編集ではなく新規作成のため、その時点ではIdentifierは存在しないので、OrderId に NullIdentifier() を設定する必要があります。
