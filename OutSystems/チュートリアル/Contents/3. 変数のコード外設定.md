# 環境変数を使ってみる
ここでは、~~サイトプロパティによるランタイム設定~~ Entityへのデータ登録を利用して、いわゆるアプリケーション全体に使える環境変数の設定方法、そしてその利用方法を学んでいきましょう。<br>
※ Service Studio から ODC Studio になってサイトプロパティという概念がなくなりました。
...
<img width="617" height="475" alt="Screenshot 2026-01-27 at 14 03 51" src="https://github.com/user-attachments/assets/0dda25ef-339a-4ff4-8b57-f95cd29d025b" /><br><br>


２．任意のEntity名を付け（ここではAppConfigにしています）、Key/Value/Description の3つのカラムを追加します。型はすべてTextでOKです。

<img width="317" height="338" alt="Screenshot 2026-01-27 at 14 07 41" src="https://github.com/user-attachments/assets/9bd590d1-140d-44b5-bb2b-a64e2eb2486f" /><br><br>


３．データを1行セットします。Keyは "WhatToSay" 、Valueは "こんにちは、" としておきましょう。「Add row」ボタンをクリックしてデータを追加したら最後に「Apply」ボタンを忘れずにクリックします。

<img width="1209" height="657" alt="Screenshot 2026-01-27 at 17 10 13" src="https://github.com/user-attachments/assets/0325716c-1d18-4a23-81fb-cef69f76666f" /><br><br>




## Server Actionの作成
さて、環境変数風に使えるEntityを作成したので、これを画面上で（クライアントで）使えるように、サーバーサイドでアクションを作成する必要があります。

### KeyをInputパラメーターとしてEntityのデータを取得するServer Actionの作成
これは、データ取得メソッドの作成です。デフォルトで(Entity)AppConfig型の結果値を取得するメソッドは作られていますが取得条件がID指定なので、新たにKeyを指定して取得するメソッドを自作します。<br><br>

１．Logicタブを選択し、Module配下のServer Actionsを右クリックし「Add Server Action」を選択します。

<img width="420" height="458" alt="Screenshot 2026-01-27 at 17 11 56" src="https://github.com/user-attachments/assets/812d3b5a-2b3d-48fc-a3ab-5dbf2ce242eb" /><br><br>

２．作成したServer ActionのNameを「GetAppConfigByKey」にします。

<img width="306" height="773" alt="Screenshot 2026-01-27 at 17 19 30" src="https://github.com/user-attachments/assets/ac8a8563-92bd-475c-871d-fd06395b2c07" /><br><br>

３．InputパラメーターをKeyにセットします。

<img width="308" height="721" alt="Screenshot 2026-01-27 at 17 23 24" src="https://github.com/user-attachments/assets/14ab98ef-054e-40a8-852a-2a405cb6daf3" /><br><br>

４．OutputパラメーターをAppConfig型のEntityにセットします。

<img width="307" height="695" alt="Screenshot 2026-01-27 at 17 23 35" src="https://github.com/user-attachments/assets/b8ce2d37-75ba-4608-989a-d54e2866eac8" /><br><br>

５．GetAppConfigByKeyのフローのStartとEndの間に「Aggregate」を配置します。

<img width="1208" height="819" alt="Screenshot 2026-01-27 at 17 38 13" src="https://github.com/user-attachments/assets/ff9d395a-7c9a-400b-abd1-6aa4ef73ead1" /><br><br>

６．先ほどセットしたAggregateとEndの間に「Assign」を配置します。

<img width="1512" height="948" alt="Screenshot 2026-01-29 at 9 30 29" src="https://github.com/user-attachments/assets/9c71b7cc-06e4-4410-a2f5-ca9cc8a4dd0f" /><br><br>

７． AssignのプロパティのValueにGetAppConfigByKeyのCurrentをセットします。

<img width="1512" height="950" alt="Screenshot 2026-01-29 at 9 31 29" src="https://github.com/user-attachments/assets/56e792d5-461f-449f-ba20-f786bec33a80" /><br><br>


### GetAppConfigByKeyを呼び出してWhatToSayを取得するServerActionの作成
１．Logicタブを選択し、Module配下のServer Actionsを右クリックし「Add Server Action」を選択します。
...
# まとめ
ここでは、環境変数の設定と使い方について学びました。 必要に応じて、復習してみてください。
